...
<body class="auth-page">
    ...
    <main class="container">
        ...
        <section class="auth-card" aria-labelledby="recuperar-title">
            ...
            <form id="form-recuperar" method="POST" action="../controllers/AuthController.php" novalidate>
                ...
                <p class="mensaje-exito" id="mensaje-exito" hidden>Si el correo existe, se envió un enlace de recuperación.</p>

                <button type="submit" name="accion" value="recuperar" class="btn-primario">Enviar enlace</button>
            </form>
